...
- **Amazon scraper** — Chromium navigation through Playwright with a separately tested defensive HTML parser.
- **Google Trends collector** — Playwright browser navigation and capture of the timeline response generated by the page.
...
- Google Trends was intermittently rate-limited during verification: 9 of 20 browser collections persisted snapshots while 11 failed cleanly. The collector preserves genuine results and never fabricates values for blocked keywords.
